          ...
          {isShown === true ? (
            <div>
              <div>
                ...
                <button class="button" onClick={() => onClickJoin()}>
                  Join
                </button>
        ...
        {isShown === false ? (
          <div>
            ...
            <div class="placement">
              ...
              <button class="button" onClick={TheRestartButton}>
                Restart Game
              </button>
              <div>
                <button class="button" onClick={() => Lshowhide()}>
                  Leaderboard{" "}
                </button>
              </div>
              {LisShown === false ? (
                  ...
                  <table class="Leaderboard">
                    ...
                    <tbody>
                      {userList.map((user, index) => (
                        <Leaderboard key={index} name={user} />
                      ))}
                    </tbody>
                  </table>
                </div>
